                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-xl-0">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdown01">
                                <!-- <li><a class="dropdown-item" href="/mods">Модули</a></li> -->
                    ...
                    <ul class="dropdown navbar-nav auth">
                        ...
                        <li>
                            <a href="#" style="padding-right:1px;" class="nav-link active dropdown-toggle" id="authUser" data-bs-toggle="dropdown" aria-expanded="false">
                                {{ auth()->user()->username }} <img style="margin:-15px 0;" src="/uploads/userpics/thumbs/{{ auth()->user()->avatar ? auth()->user()->username . '.' . auth()->user()->avatar : 'default.png' }}?{{time()}}" alt="" width="38" class="img-fluid mx-1 rounded-circle"/>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="authUser">
                                <li><a class="dropdown-item" href="{{ route('profile.index') }}">
                                    <i class="fa fa-user-circle-o fa-fw"></i> Профиль</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('rss.index') }}">
                                    <i class="fa fa-rss fa-fw"></i> Мои ленты</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('categories.index') }}">
                                    <i class="fa fa-folder fa-fw"></i> Категории</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('comments.index') }}">
                                    <i class="fa fa-comment fa-fw"></i> Комментарии</a>
                                </li>
                        ...
                        @else 
                        <li><a class="nav-link" href="{{ route('login') }}" data-form="login" data-bs-toggle="modal" data-bs-target="#myModal" title="Авторизация"><i class="fa fa-sign-in" aria-hidden="true"></i> Вход</a></li> 
            ...
            <div class="text-center bg-black py-3">
                <small>
                    <a href="{{ route('home') }}" class="text-muted text-decoration-none">
                        © {{ str(config('app.name'))->replace('_', ' ') }} 2020 - {{ date('Y') }}
                    </a>
                </small>
            </div>
		</footer>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h6 class="modal-title" id="modalHeader">Авторизация</h6>
						<a class="btn-close" data-bs-dismiss="modal" aria-label="Close"></a>
					</div>
					<div class="modal-body" id="modalBody"></div>
					<div class="modal-footer">
						<button type="submit" class="btn btn-primary w-25" style="display: none;">Coxранить</button>
						<button type="button" class="btn btn-secondary w-25" data-bs-dismiss="modal">Закрыть</button>
					</div>
				</div>
			</div>
		</div>
